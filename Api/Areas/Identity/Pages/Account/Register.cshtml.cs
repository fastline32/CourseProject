...
namespace Api.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            if (!await _roleManager.RoleExistsAsync(WebConstants.EditorRole))
            {
                await _roleManager.CreateAsync(new IdentityRole(WebConstants.EditorRole));
            }
            if (!await _roleManager.RoleExistsAsync(WebConstants.CustomerRole))
            {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                if (_userManager.Users.FirstOrDefault(x => x.DisplayName == Input.DisplayName) != null)
                {
                    ModelState.AddModelError("","Username is in use");
                    return Page();
                }
